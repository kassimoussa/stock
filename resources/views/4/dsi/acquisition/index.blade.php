        ...
        <div id="div1">
            <table class="table tablesorter table-sm table-hover" id="">
                ...
                <tbody>
                    ...
                    @php
                    $status_dir = ''; $status_sih = ''; $status_dsi = ''; $btnhidden = ''; $titre = ''; $icon = ''; $btnshow = 'hidden'; $btntitle = ''; $btnclick = ''; $btnlivraison = 'hidden';

                        if($acquisition->status_dir == 'approuve'){ $status_dir = '#089415'; }
                        elseif($acquisition->status_dir == 'attente'){ $status_dir = '#efaa2d'; $btnhidden = '';}
                        ...
                        if($acquisition->status_dsi == 'approuve'){ 
                            $status_dsi = '#089415'; $btnhidden = 'hidden'; $btnshow = '';  
                        ...
                        if($acquisition->status == '1'){ $titre = 'Rendre la fiche invisible aux autres';  $icon = 'times-circle';  }
                        elseif($acquisition->status == '0'){ $titre = 'Rendre la fiche visible aux autres';  $icon = 'check-circle';  }
                    ...
                    @endphp
                        <tr>
                            ...
                            <td>
                                <form action="{{ url('/acquisition/recu', $acquisition) }}" method="post" class="d-inline">
                                    @csrf
                                    @method('put')
                                    <button type="button" class="btn btn-outline-primary" {{ $btnshow }} {{ $btnclick }}
                            ...
                            <td>
                                ...
                                <form action="{{ url('/acquisition/delete', $acquisition) }}" method="post" class="d-inline">
                                    @csrf
                                    @method('delete')
