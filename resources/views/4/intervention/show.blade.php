    ...
    <div class="row mt-3">
        ...
        <div class="row">
            ...
            @if ($intervention->status_direction == null)
                <form action="{{ url('/intervention/commentaire', $intervention) }}" role="form" method="post"
                    class="form">
                    @csrf
                    @method("PUT")
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="form-check form-check-inline ">
                                        <input class="form-check-input" type="radio" name="status_direction" id="Approuver"
                                            value="approuve" {{ $approuve }}>
                                        <label class="form-check-label" for="Approuver">Approuver</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status_direction" id="attente"
                                            value="attente" {{ $attente }}>
                                        <label class="form-check-label" for="attente">En attente</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status_direction" id="rejete"
                                            value="rejete" {{ $rejete }}>
                                ...
                                <div class="row" style="text-align: center; margin-top: 2%;">
                                    <div class="col-md-12 form-group text-center">
                                        ...
                                        <input type="text" name="date_dir_approbation" value="{{ date('Y-m-d H:i:s') }}"
                                            hidden>
                                    </div>
                                </div>
                            </div>
            ...
            @elseif ($intervention->status_direction != null)
            <form action="{{ url('/intervention/commentaire', $intervention) }}" role="form" method="post"
                    class="form">
                    @csrf
                    @method("PUT")
                        ...
                        <div class="card-body">
                            @php
                                ...
                                if ($intervention->status_direction == 'approuve') {
                                    $approuve = 'checked';
                                    $button = 'hidden';
                                    $attente = $rejete = ' disabled '; $comm = ' readonly';
                                } elseif ($intervention->status_direction == 'attente') {
                                    $attente = 'checked'; /* $approuve = $rejete =  ' disabled ' */
                                } elseif ($intervention->status_direction == 'rejete') {
                                    $rejete = 'checked'; /* $approuve = $attente =  ' disabled ' */
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text fw-bold">Commentaire</span>
                                <textarea name="commentaire" id="" class="form-control" cols="30"
                                    rows="2" {{ $comm }}>{{ $intervention->commentaire }}</textarea>
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text fw-bold">Date</span>
                                <label
                                    class="form-control">{{ date('d/m/Y', strtotime($intervention->date_dir_approbation)) }}
                                </label>
                            </div>
                            <div class="row" style="text-align: center; margin-top: 2%;" {{ $button }} >
                                <div class="col-md-12 form-group text-center">
                                    <button type="submit" name="submit"
                                        class="btn btn-primary fw-bold">Soumettre</button>
                ...
                <div class="col-lg-12">
                    <div class="card  mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_service" id="Approuver"
                                        value="approuve" {{ $approuve }}>
                                    <label class="form-check-label" for="Approuver">Approuver</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_service" id="attente"
                                        value="attente" {{ $attente }}>
                                    <label class="form-check-label" for="attente">En attente</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_service" id="rejete"
                                        value="rejete" {{ $rejete }}>
                                    <label class="form-check-label" for="rejete">Rejeter</label>
                                </div>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text fw-bold">Date</span>
                                <label
                                    class="form-control">{{ date('d/m/Y', strtotime($intervention->date_ser_approbation)) }}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card  mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_division" id="Approuver"
                                        value="approuve" {{ $approuve }}>
                                    <label class="form-check-label" for="Approuver">Approuver</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_division" id="attente"
                                        value="attente" {{ $attente }}>
                                    <label class="form-check-label" for="attente">En attente</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_division" id="rejete"
                                        value="rejete" {{ $rejete }}>
                                    <label class="form-check-label" for="rejete">Rejeter</label>
                                </div>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text fw-bold">Date</span>
                                <label
                                    class="form-control">{{ date('d/m/Y', strtotime($intervention->date_div_approbation)) }}
                                </label>
                            </div>
                        </div>
                    </div>
