@extends('4.layout', ['page' => 'Nouvelle Acquisition', 'pageSlug' => 'acquisition'])
@section('content')
        ...
        $(function() {
            $('input[type="radio"]').click(function() {
                if ($(this).attr('id') == "autre") {
                    ...
                    $("#inputautre").show();
                    $("#marque").show();
                    document.getElementById('marque_mat').value = " ";
                    $("#model").show();
                    document.getElementById('model_mat').value = " ";
                    $("#processeur").hide();
                    $("#ram").hide();
                    $("#stockage").hide();
                    $("#os").hide();
                ...
                if (($(this).attr('id') == "pcp") || ($(this).attr('id') == "pcb")) {
                    ...
                    $("#quant").show();
                    $("#marque").show();
                    document.getElementById('marque_mat').value = pc.marque_mat;
                    $("#model").show();
                    document.getElementById('model_mat').value = pc.model_mat;
                    $("#processeur").show();
                    document.getElementById('processeur_mat').value = pc.processeur_mat;
                    $("#ram").show();
                    document.getElementById('ram_mat').value = pc.ram_mat;
                    $("#stockage").show();
                    document.getElementById('stockage_mat').value = pc.stockage_mat;
                    $("#os").show();
                    document.getElementById('os_mat').value = pc.os_mat;
                    $("#inputautre").hide();
                    $("#desc").hide();
                }
