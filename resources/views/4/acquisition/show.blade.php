...
@endphp
@extends('4.layout', ['page' => 'Fiche Acquisition', 'pageSlug' => 'acquisition'])
@section('content')
    <br>
    <div class="container ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-12 form-group ">
                                                            ...
                                                            <button type="reset"
                                                                class="btn btn-default fw-bold">Annuler</button>
            ...
            <div class="card-body">
                ...
                @else
                    <div class="alert alert-danger">
                        <h3 class="fw-bold"> Le Chef de SIH n'a pas encore
