...
@endphp
@extends('2.layout', ['page' => 'Fiche Acquisition', 'pageSlug' => 'acquisition'])
@section('content')
    <br>
    <div class="container ">
            ...
            <div class="col">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <button hidden type="button" name="add_devis" class="btn btn-dark fw-bold" data-bs-toggle="modal"
        ...
        <div class="card  mb-3" style="width: 100%;">
            ...
            @else
            <div class="alert alert-danger">
                <h3 class="fw-bold"> Le Chef de SIH </h3>
            </div>
            @endif
        </div>
