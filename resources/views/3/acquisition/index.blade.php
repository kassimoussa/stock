            ...
            <div class="row">
                <form action="" class="">
                    <div class="input-group  mb-3">
                        ...
                        <input type="text" class="form-control " name="search" placeholder="" value="{{ $search }}" placeholder="Par numero de fiche, direction, service, materiel">
                    </div>
                </form>
            </div>
        </div>
